...
pub fn resolve_push_tags(
    ...
    let override_raw = std::env::var("AIVCS_OCI_TAGS").ok();
    resolve_push_tags_with_override(
        package_version,
        registry_defaults,
        extra,
...
fn resolve_push_tags_with_override(
    package_version: &str,
    registry_defaults: &[String],
    extra: &[String],
...
mod tests {
    ...
    fn resolve_push_tags_deduplicates() {
        let tags = resolve_push_tags_with_override(
            "0.3.2",
            &["latest".to_string()],
            &["0.3.2".to_string()],
            None,
    ...
    fn resolve_push_tags_honors_env_override() {
        let tags = resolve_push_tags_with_override("0.3.1", &[], &[], Some("canary,0.3.2"));
